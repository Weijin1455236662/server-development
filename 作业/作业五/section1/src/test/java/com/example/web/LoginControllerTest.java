...
public class LoginControllerTest {
    ...
    public void loginFail() throws Exception {
        ...
        when(userService.hasMatcher("test", "123456")).thenReturn(false);
        ...
        verify(userService).hasMatcher("test", "123456");
    }
    ...
    public void loginSuccess() throws Exception {
        UserService userService = mock(UserService.class);
        when(userService.hasMatcher("admin", "123456")).thenReturn(true);
        ...
        verify(userService).hasMatcher("admin", "123456");
