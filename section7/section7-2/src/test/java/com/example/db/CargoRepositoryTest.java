...
public class CargoRepositoryTest {
    ...
    @Transactional
    public void findOne() {
        Cargo thirteen = cargoRepository.findOne(13L);
    ...
    public void findByCustomer() {
        List<Cargo> cargos = cargoRepository.findByCustomerIdOrderByOrderDateDesc(4L);
    ...
    public void save() {
        assertEquals(15, cargoRepository.count());
        Customer customer = cargoRepository.findOne(13L).getCustomer();
    ...
    public void delete() {
        assertEquals(15, cargoRepository.count());
        assertNotNull(cargoRepository.findOne(13L));
        cargoRepository.delete(13L);
        assertEquals(14, cargoRepository.count());
        assertNull(cargoRepository.findOne(13L));
    }
