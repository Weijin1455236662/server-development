...
//@ContextConfiguration("classpath:com/example/db/jdbc/JdbcRepositoryTests-context.xml")
public class CustomerRepositoryTest {
    ...
    public void save_newCustomer() {
        System.out.println("--1--" + customerRepository.count());
        assertEquals(4, customerRepository.count());
        Customer customer = new Customer(null, "zhaosi", "address5", "nanjing",
                "zhaosi@163.com");
        Customer saved = customerRepository.save(customer);
        System.out.println("--2--" + saved.getId());
...
//    source C:/codej/section6-1/src/test/resources/com/example/db/jdbc/test-for-mysql.sql;